...
 name =  "csestoragelogoteam12" #add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long. 
...
 name      =  "cselogsteam12" #add your team name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long. 
 resource_group_name   =  var.rg_name 
 location     =  var.location 
...
resource "azurerm_mysql_flexible_server" "serverformation1" {  
 name    =  "serveriacteam12" #add your team name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long. 
 location    =  var.location  
 resource_group_name  =  var.rg_name   
 administrator_login   =  "admin12"  
 administrator_password =  "W89GTi*!2f"  
